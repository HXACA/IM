...
public class EaseChatFragment extends EaseBaseFragment implements EMMessageListener {
    ...
    protected void initView() {
        ...
        inputMenu.setChatInputMenuListener(new ChatInputMenuListener() {
            ...
            public void onBigExpressionClicked(EaseEmojicon emojicon) {
                Log.d("Identity",String.valueOf(emojicon.getIdentityCode()));
    ...
    protected void registerExtendMenuItem(){
        ...
        inputMenu.registerExtendMenuItem(R.string.attach_video_call, R.drawable.em_chat_video_call_selector, ITEM_VIDEO, extendMenuItemClickListener);
    ...
    protected void selectFileFromLocal() {
        Intent intent = null;
        if (Build.VERSION.SDK_INT < 190) { //api 19 and later, we can't use this way, demo just select from images
